...
export const metadata: Metadata = {
  title: "Manga Movie Theatre - Immerse in the World of Manga",
  description: "Discover an unforgettable viewing experience with classic and contemporary manga movies.",
  openGraph: {
    title: "Manga Movie Theatre",
    description: "Explore an exceptional selection of manga films.",
    siteName: "Manga Movie Theatre",
    images: [{ url: "https://images.pexels.com/photos/7991505/pexels-photo-7991505.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "A woman in a black dress sits alone in a dimly lit theater with red seats." }],
    type: "website"
  },
  twitter: {
    ...
    title: "Manga Movie Theatre",
    description: "Discover an unforgettable viewing experience with classic and contemporary manga movies.",
    images: ["https://images.pexels.com/photos/7991505/pexels-photo-7991505.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
